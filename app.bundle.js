...
function renderImportPreview() {
  ...
  candidates.forEach((entry, index) => {
    ...
    labelInput2.className = "preview-label";
    labelInput2.value = entry.label;
    labelField.append(labelText, labelInput2);
    const tagsField = document.createElement("label");
    const tagsText = document.createElement("span");
    tagsText.textContent = "Tags";
    const tagsInput2 = document.createElement("input");
    tagsInput2.type = "text";
    tagsInput2.className = "preview-tags";
    tagsInput2.value = (entry.tags || []).join(", ");
